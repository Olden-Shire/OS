package com.os1.runescript.plugin.cli
...
/**
 * Bridge to the OS1 Rust CLI (`crates/app`). The plugin never re-implements the cs2
...
object Os1Cli {
    ...
    const val BUILD_HINT: String =
        "OS1 CLI not found — build it with `cargo build -p app --release` in the workspace root."

...
import com.os1.runescript.plugin.asm.Cs2AsmFileType
...
class Cs2AsmPreviewEditor(
    ...
    private fun compile(sourceText: String): String {
        if (Os1Cli.findBinary(project) == null) return Os1Cli.BUILD_HINT
        val tmp = Files.createTempFile("os1_cs2_preview", ".cs2")
        return try {
            ...
            val result = Os1Cli.run(project, *args.toTypedArray())
                ?: return Os1Cli.BUILD_HINT

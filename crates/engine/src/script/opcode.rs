//! RuneScript bytecode opcodes — mirrors the Engine-TS reference
//! ScriptOpcode.ts (compiler version 26). Values are wire-format; the
//! compiler emits them into script.dat.
...
pub const IF_SETCOLOUR: u16 = 2042;
pub const IF_SETHIDE: u16 = 2043;
pub const IF_SETMODEL: u16 = 2044;
pub const IF_SETNPCHEAD: u16 = 2045;
pub const IF_SETOBJECT: u16 = 2046;
pub const IF_SETPLAYERHEAD: u16 = 2047;
pub const IF_SETPOSITION: u16 = 2048;
pub const IF_SETRESUMEBUTTONS: u16 = 2049;
pub const IF_SETROTATION: u16 = 2050;
pub const IF_SETSCROLLPOS: u16 = 2051;
pub const IF_SETTAB: u16 = 2052;
pub const IF_SETTABACTIVE: u16 = 2053;
pub const IF_SETTEXT: u16 = 2054;
pub const LAST_COM: u16 = 2055;
pub const LAST_INT: u16 = 2056;
pub const LAST_ITEM: u16 = 2057;
pub const LAST_LOGIN_INFO: u16 = 2058;
pub const LAST_SLOT: u16 = 2059;
pub const LAST_TARGETSLOT: u16 = 2060;
pub const LAST_USEITEM: u16 = 2061;
pub const LAST_USESLOT: u16 = 2062;
pub const LONGQUEUE: u16 = 2063;
pub const LONGQUEUEVARARG: u16 = 2064;
pub const LOWMEM: u16 = 2065;
pub const MES: u16 = 2066;
pub const MIDI_JINGLE: u16 = 2067;
pub const MIDI_SONG: u16 = 2068;
pub const MINIMAP_TOGGLE: u16 = 2069;
pub const NAME: u16 = 2070;
pub const P_ANIMPROTECT: u16 = 2071;
pub const P_APRANGE: u16 = 2072;
pub const P_ARRIVEDELAY: u16 = 2073;
pub const P_CLEARPENDINGACTION: u16 = 2074;
pub const P_COUNTDIALOG: u16 = 2075;
pub const P_DELAY: u16 = 2076;
pub const P_EXACTMOVE: u16 = 2077;
pub const P_FINDUID: u16 = 2078;
pub const P_LOCMERGE: u16 = 2079;
pub const P_LOGOUT: u16 = 2080;
pub const P_OPHELD: u16 = 2081;
pub const P_OPLOC: u16 = 2082;
pub const P_OPNPC: u16 = 2083;
pub const P_OPNPCT: u16 = 2084;
pub const P_OPOBJ: u16 = 2085;
pub const P_OPPLAYER: u16 = 2086;
pub const P_OPPLAYERT: u16 = 2087;
pub const P_PAUSEBUTTON: u16 = 2088;
pub const P_PREVENTLOGOUT: u16 = 2089;
pub const P_RUN: u16 = 2090;
pub const P_STOPACTION: u16 = 2091;
pub const P_TELEJUMP: u16 = 2092;
pub const P_TELEPORT: u16 = 2093;
pub const P_TRANSMOGRIFY: u16 = 2094;
pub const P_WALK: u16 = 2095;
pub const PLAYERMEMBER: u16 = 2096;
pub const PROJANIM_PL: u16 = 2097;
pub const QUEUE: u16 = 2098;
pub const QUEUEVARARG: u16 = 2099;
pub const READYANIM: u16 = 2100;
pub const RUNANIM: u16 = 2101;
pub const RUNENERGY: u16 = 2102;
pub const SAY: u16 = 2103;
pub const SESSION_LOG: u16 = 2104;
pub const SET_PLAYER_OP: u16 = 2105;
pub const SETGENDER: u16 = 2106;
pub const SETIDKIT: u16 = 2107;
pub const SET_SKILL_LEVEL: u16 = 2108;
pub const SETSKINCOLOUR: u16 = 2109;
pub const SETTIMER: u16 = 2110;
pub const SOFTTIMER: u16 = 2111;
pub const SOUND_SYNTH: u16 = 2112;
pub const SPOTANIM_PL: u16 = 2113;
pub const STAFFMODLEVEL: u16 = 2114;
pub const STAT_ADD: u16 = 2115;
pub const STAT_ADVANCE: u16 = 2116;
pub const STAT_BASE: u16 = 2117;
pub const STAT_BOOST: u16 = 2118;
pub const STAT_DRAIN: u16 = 2119;
pub const STAT_HEAL: u16 = 2120;
pub const STAT_RANDOM: u16 = 2121;
pub const STAT_SUB: u16 = 2122;
pub const STAT_TOTAL: u16 = 2123;
pub const STAT: u16 = 2124;
pub const STRONGQUEUE: u16 = 2125;
pub const STRONGQUEUEVARARG: u16 = 2126;
pub const TURNANIM: u16 = 2127;
pub const TUT_CLOSE: u16 = 2128;
pub const TUT_FLASH: u16 = 2129;
pub const TUT_OPEN: u16 = 2130;
pub const UID: u16 = 2131;
pub const WALKANIM_B: u16 = 2132;
pub const WALKANIM_L: u16 = 2133;
pub const WALKANIM_R: u16 = 2134;
pub const WALKANIM: u16 = 2135;
pub const WALKTRIGGER: u16 = 2136;
pub const WEAKQUEUE: u16 = 2137;
pub const WEAKQUEUEVARARG: u16 = 2138;
pub const WEALTH_EVENT: u16 = 2139;
pub const WEIGHT: u16 = 2140;
...
pub const NPC_TELEJUMP: u16 = 2542;
pub const NPC_TYPE: u16 = 2543;
pub const NPC_UID: u16 = 2544;
pub const NPC_WALK: u16 = 2545;
pub const NPC_WALKTRIGGER: u16 = 2546;
pub const PROJANIM_NPC: u16 = 2547;
pub const SPOTANIM_NPC: u16 = 2548;
...
/// Whether the opcode carries a 4-byte operand (else 1-byte) — the
/// ScriptFile decode rule from the reference (`isLargeOperand`).
pub fn is_large_operand(opcode: u16) -> bool {
    if opcode > 100 {
        return false;
    }
    !matches!(opcode, RETURN | POP_INT_DISCARD | POP_STRING_DISCARD | GOSUB | JUMP)
}

/// Best-effort opcode → name for error reporting.
pub fn name(opcode: u16) -> &'static str {
    match opcode {
        ...
        JUMP => "jump",
        SWITCH => "switch",
        PUSH_VARBIT => "push_varbit",
        POP_VARBIT => "pop_varbit",
        ...
        JUMP_WITH_PARAMS => "jump_with_params",
        DEFINE_ARRAY => "define_array",
        PUSH_ARRAY_INT => "push_array_int",
        POP_ARRAY_INT => "pop_array_int",
        MES => "mes",
        ANIM => "anim",
        SAY => "say",
        COORD => "coord",
        ...
        GENDER => "gender",
        P_TELEJUMP => "p_telejump",
        P_TELEPORT => "p_teleport",
        P_WALK => "p_walk",
        P_RUN => "p_run",
        MIDI_SONG => "midi_song",
        MIDI_JINGLE => "midi_jingle",
        SOUND_SYNTH => "sound_synth",
        RUNENERGY => "runenergy",
        SPOTANIM_PL => "spotanim_pl",
        NPC_ADD => "npc_add",
        NPC_ANIM => "npc_anim",
        NPC_SAY => "npc_say",
        NPC_DEL => "npc_del",
        NPC_COORD => "npc_coord",
        NPC_TYPE => "npc_type",
        NPC_FACESQUARE => "npc_facesquare",
        NPC_TELE => "npc_tele",
        SPOTANIM_NPC => "spotanim_npc",
        _ => "unknown",
    }
}
